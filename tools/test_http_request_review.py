    ...
    def test_api(self,item):
        if item["model"] == "login_review":
            ...
            try:
                ...
                DoExcel.write_back(test_case_path,'review',item['case_id']+1,str(res_login.json()),TestResult)
            ...
            try:
                ...
                DoExcel.write_back(test_case_path,'review',item['case_id']+1,str(res_notice.json()),TestResult)
